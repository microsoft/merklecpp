...
.. important::
   Every example on this page uses an imaginary tile width of 32
...
+------------------------------+----------------+----------------------+
| Tree levels spanned by one   | 5              | 8                    |
| tile                         |                |                      |
+------------------------------+----------------+----------------------+
| Leaves covered by one full   | 32             | 256                  |
| level-0 tile                 |                |                      |
+------------------------------+----------------+----------------------+
| Leaves covered by one        | 32             | 256                  |
| level-1 entry                |                |                      |
+------------------------------+----------------+----------------------+
| Leaves covered by one full   | 1,024          | 65,536               |
| level-1 tile                 |                |                      |
+------------------------------+----------------+----------------------+
...
+-----------+--------------------+---------------------+---------------+------------------+------------------+
| 1,030     | 1,024              | 32 level-0 tiles +  | ``[0, 1023)`` | ``[1023, 1024)`` | ``[1024, 1030)`` |
|           |                    | ``tile/1/000``      |               |                  |                  |
+-----------+--------------------+---------------------+---------------+------------------+------------------+
...
+========+=========================+========+=========================+
| ``P0`` | ``R[16, 20)``           | tile   | Seed shared by old and  |
|        |                         |        | new reconstructions     |
+--------+-------------------------+--------+-------------------------+
| ``P1`` | ``R[20, 24)``           | tile   | Extend only the new     |
|        |                         |        | reconstruction          |
+--------+-------------------------+--------+-------------------------+
| ``P2`` | ``R[24, 32)``           | tile   | Extend only the new     |
|        |                         |        | reconstruction          |
+--------+-------------------------+--------+-------------------------+
| ``P3`` | ``R[0, 16)``            | tile   | Complete both the old   |
|        |                         |        | and new left sides      |
+--------+-------------------------+--------+-------------------------+
| ``P4`` | ``R[32, 40)``           | memory | Extend the new          |
|        |                         |        | reconstruction to size  |
|        |                         |        | 40                      |
+--------+-------------------------+--------+-------------------------+
